...
const envSchema = z.object({
  ...
  PICOCLAW_HTTP_HOST: z.string().default('127.0.0.1'),
  PICOCLAW_HTTP_PORT: z.coerce.number().int().positive().default(8787),
  PICOCLAW_GATEWAY_CONTAINER: z.string().default('picoclaw-gateway'),
